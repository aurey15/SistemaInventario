...
namespace SistemaInventario.AccesoDatos.Repositorio
{
    public class BodegaRepositorio : Repositorio<Bodega>, IBodegaRepositorio
    {
        ...
        public void Actualizar(Bodega bodega) //Actualiza el registron con el que estamos trabajando
        {
            //Capturamos el registro en base al ID antes de actualizarlo
            var bodegaBD = _db.Bodegas.FirstOrDefault(b => b.Id == bodega.Id);
            if (bodegaBD != null)//Verificamos si encontro el registro y si, si lo actualizamos
            {
