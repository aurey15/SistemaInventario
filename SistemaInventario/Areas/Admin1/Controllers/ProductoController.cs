...
namespace SistemaInventario.Areas.Admin1.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Upsert(int? id)
        {
            ...
            {
                // Actualizar Producto respecto al Id
        ...
        public async Task<IActionResult> Upsert(ProductoVM productoVM)
        {
            ...
            {
                var files = HttpContext.Request.Form.Files;//Captura todo lo que le pasamos, especialmente los archivos
                string webRootPath = _webHostEnvironment.WebRootPath;//Captura el directorio wwwroot
        ...
        {
            //Necesitamos las propiedades de navegacion de categoria y marca    
            //De esta manera no solo nos traera los datos de producto sino a que categoria y marca pertenece
